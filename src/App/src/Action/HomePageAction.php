...
use Hkt\IlluminateView\BladeRenderer;
...
class HomePageAction implements ServerMiddlewareInterface
{
    ...
    public function process(ServerRequestInterface $request, DelegateInterface $delegate)
    {
        ...
        } elseif ($this->template instanceof BladeRenderer) {
            $data['templateName'] = 'Illuminate Blade';
            $data['templateDocs'] = 'https://laravel.com/docs/5.4/views';
        }
